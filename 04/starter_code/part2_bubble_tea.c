...
int main(void) {
    ...
    // Calculate the cost
    double total_cost = calculate_order_cost(order);
    ...
    print_order_cost(order, total_cost);
...
double calculate_order_cost(struct bubble_tea order) {
